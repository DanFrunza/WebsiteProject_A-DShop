...
$isAdmin = $username === "admin"; // Verificarea drepturilor de admin este bazată pe variabila de sesiune, nu pe cookie
...
if (isset($_COOKIE['remember_username']) && empty($username)) {
    ...
    $_SESSION['username'] = $username; // Actualizarea variabilei de sesiune cu username-ul din cookie
}
